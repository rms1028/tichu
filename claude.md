...
턴 외 폭탄 인터럽트 UI 가능 여부 판단용. 핸드에서 `currentTable` 보다 강한 모든 폭탄 반환.
...
|---|------|------|
| 28 | 패스 직후 폭탄 | 가능 |
| 29 | 동시 복수 폭탄 | **선착순**. 먼저 도착한 폭탄이 즉시 적용되고, 이후 폭탄은 `canBeat` 에서 거부 (§6.6) |
| 30 | 폭탄에 폭탄 | 가능. 더 강한 폭탄이 즉시 재인터럽트 |
| 31 | 폭탄 승리 후 나감 | 나감 + 다음 활성 플레이어에게 턴 이전 |
| 32 | 폭탄 + 용 | 용 위 폭탄 가능. 용 양도 미발생 |
| 33 | 팀원에게 폭탄 | 허용. 팀 무관 |
| 34 | 나감 + 다른 플레이어의 폭탄 인터럽트 | 나감 번복 불가. 트릭 귀속만 변경 |
| 35 | 폭탄 인터럽트 중 타이머 | 기존 턴 타이머 정리 후 다음 플레이어 기준 풀 타이머 재시작 |
