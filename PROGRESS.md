...
- **2단계** — visual-test scenario 05+ 의 GameScreen 확장. Reanimated 카드 뷰가 adb tap 을 hit-test 통과 못하는 문제는 별도 작업 필요 (deeplink 테스트 모드 또는 accessibilityLabel). 접근 A/B 트레이드오프 + POC 는 새 세션에서.
